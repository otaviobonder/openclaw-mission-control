...
async def start_onboarding(
    ...
    prompt = (
        ...
        '{"id":"2","label":"..."}]}\n\n'
        "COMPLETION payload (when you have enough info, one final request):\n"
        ...
        '"lead_agent":{"name":"...","identity_profile":{"role":"Board Lead",'
        '"communication_style":"...","emoji":"..."},'
        '"autonomy_level":"...","verbosity":"...","output_format":"...",'
        '"update_cadence":"...","custom_instructions":"..."}}\n\n'
        "ENUMS:\n"
        ...
        "RULES:\n"
        "- Send one question per request. Do NOT wrap in a list or add commentary.\n"
        "- The completion payload must include board_type. If board_type=goal, "
        "include objective + success_metrics.\n"
        "- Include user_profile + lead_agent to configure the board lead.\n"
    )
